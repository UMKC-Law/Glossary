...
“A meeting in which all stakeholders in a project attempt to resolve conflicts and map solutions.” From:  http://en.wikipedia.org/wiki/Charrette
</dd>

<dt><b>Checksum</b><dt>
<dd>is a number generated by a calculation (called a hashing) that is applied to file.  
The checksum can be used ensure the integrity of a file or identify it.  
Git uses its check sum to identify, that is name files internally.
</dd>
